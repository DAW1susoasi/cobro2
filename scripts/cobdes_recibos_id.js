...
function getRecibos(){
    ...
    ajax("http://localhost/cobro2/cobdes_id/cobdes_id_dinamico.php", "POST", "txt", setRecibos, formData);
}
...
function submit(event){
    ...
    ajax("./cobdes_id_dinamico.php", "POST", "txt", setRecibos, formData);
}
...
function botonCobrarClick(){
    botonCobrar.addEventListener("click", function() {
        ...
        ajax("./cobdes_id_dinamico.php", "POST", "nada", getRecibos, formData);
    });
}
