...
function getRecibos(){ 
    ...
    ajax("http://localhost/cobro2/recibos_mes/recibos_mes_dinamico.php", "POST", "txt", setRecibos, formData);
}
...
function submit(event){
    ...
    ajax("./recibos_mes_dinamico.php", "POST", "nada", getRecibos, formData);
}
